package jamarfal.jalbertomartinfalcon.audiolibros.customviews;
...
public class ZoomSeekBar extends View { // Valor a controlar
    ...
    private SeekBarValueChangeListener seekBarValueChangeListener;
    ...
    public void setVal(int val) {
        if (valMin <= val && val <= valMax) {
            ...
            if (this.seekBarValueChangeListener != null)
                this.seekBarValueChangeListener.valueChanged(this.val);
            invalidate();
        }
    }
    ...
    public void setOnSeekBarValueChangeListener(SeekBarValueChangeListener seekBarValueChangeListener) {
        this.seekBarValueChangeListener = seekBarValueChangeListener;
    }
}
